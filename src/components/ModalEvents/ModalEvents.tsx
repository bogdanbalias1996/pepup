...
import {closeEventModal, setQuantity, purchaseEventTicket} from '../../pages/Events/actions';
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  purchaseEventTicket: (id: string, qnt: ModalEventsFromDataProps) => dispatch(purchaseEventTicket(id, qnt) as any)
});
        ...
        <View style={styles.wrapModalContent}>
          ...
          <View style={styles.modalFooter}>
            ...
            <View style={styles.changeItem}>
              <Text numberOfLines={1} style={[styles.infoLabel, styles.infoLabelQnt]}>Choose quantity</Text>
              <ModalSelector
                ...
                selectStyle={{borderRadius: 30, width: 100, padding: 5, height: 44, justifyContent: 'center'}}
                cancelText="Cancel"
              />
            </View>
            <ButtonStyled
